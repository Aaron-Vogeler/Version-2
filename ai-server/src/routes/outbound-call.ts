...
router.post("/", async (req: Request, res: Response) => {
  try {
    ...
    const clientStatePayload = JSON.stringify({
      ...
      // Gemini custom prompt mode - bypass cache and use custom system prompt
      geminiUseCustomPrompt: geminiUseCustomPrompt ?? null,
    });
